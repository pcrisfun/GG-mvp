# app/models/interviewinquiry.rb

class Interviewinquiry
  ...
  validates_presence_of :message, :message => "Please include at least 3 available meeting times"
  ...
  def deliver
    ...
    Pony.mail({
      :from => %("#{name}" <#{email}>),
      :reply_to => email,
      :subject => "I'd like to schedule an interview",
      :body => message,
