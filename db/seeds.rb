...
first_workshop = tahila.workshops.create!(             "host_firstname"=>"Tahila Mintz &",
                                                        ...
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"terukonimura@gmail.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
...
first_workshop = anna.workshops.create!(             "host_firstname"=>"Anna",
                                                        "host_lastname"=>"Gieselman",
                                                        "host_business"=>"Rarefactions Jewelry",
                                                        "topic"=>"Elegant Hoops & Beads Jewelry Making",
                                                        "description"=>"Learn to make your own simple beaded hoop earrings as well as bead and wire necklaces.",
                                                        "skill_list"=>"'jewelry design','beading','wire forming'",
                                                        "tool_list"=>"'wire snips','flat-nosed pliers','beading wire','beading crimps','beads'",
                                                        "requirement_list"=>"",
                                                        "other_needs"=>"",
                                                        ...
                                                        "ends_at_time"=>"03:00 PM",
                                                        "datetime_tba"=>"1",
                                                        "location_address"=>"Bob Weaver Jewelry Studio",
                                                        "location_address2"=>"",
                                                        "location_city"=>"Austin",
                                                        "location_state"=>"TX",
                                                        ...
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"anna@rarewears.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
...
first_workshop = ann.workshops.create!(             "host_firstname"=>"Ann",
                                                        ...
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"ann.armstrong@yahoo.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
...
first_workshop = elizabeth.workshops.create!(             "host_firstname"=>"Elizabeth",
                                                        "host_lastname"=>"Chiles",
                                                        "host_business"=>"",
                                                        "topic"=>"Storytelling Through Photography",
                                                        "description"=>"This 3 1/2 hour workshop will entail: Making pictures in a beautiful environment and working with them to sequence a group that can convey a story and tell of your unique experience in a place. I will be working with you one on one to achieve this and we will look at excellent examples of successful photographers with a skill at storytelling through pictures!",
                                                        "skill_list"=>"'photography','story sequencing','visual storytelling'",
                                                        "tool_list"=>"'digital camera'",
                                                        "requirement_list"=>"",
                                                        "other_needs"=>"",
                                                        "age_min"=>"11", "age_max"=>"19",
                                                        "registration_min"=>"2",
                                                        ...
                                                        "ends_at_time"=>"03:00 PM",
                                                        "datetime_tba"=>"1",
                                                        "location_address"=>"Elizabeth's home in Tarrytown",
                                                        "location_address2"=>"",
                                                        "location_city"=>"Austin",
                                                        "location_state"=>"TX",
                                                        "location_zipcode"=>"78703",
                                                        "location_private"=>"1",
                                                        "location_nbrhood"=>"Tarrytown",
                                                        "price"=>"40",
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"elizabethchiles@gmail.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
...
first_workshop = callen.workshops.create!(             "host_firstname"=>"Callen",
                                                        ...
                                                        "topic"=>"Pattern Making, from Original Painting to Digital Print",
                                                        ...
                                                        "skill_list"=>"'watercolor painting','digital scanning','Photoshop','pattern making'",
                                                        "tool_list"=>"'sumie ink','paper','watercolors','Photoshop','EPSON large-format printer'",
                                                        "requirement_list"=>"",
                                                        "other_needs"=>"",
                                                        "age_min"=>"11", "age_max"=>"99",
                                                        "registration_min"=>"2",
                                                        ...
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"calliehelen@gmail.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
...
first_workshop = caroline.workshops.create!(             "host_firstname"=>"Caroline",
                                                        ...
                                                        "host_business"=>"",
                                                        "topic"=>"Process-based Painting",
                                                        "description"=>"Learn techniques for process-based paintings, where you'll be encouraged to respond to your own instincts.",
                                                        "skill_list"=>"'Acrylic painting','creative process'",
                                                        "tool_list"=>"'Acrylic paint','brushes','paper bags','rice paper'",
                                                        "requirement_list"=>"",
                                                        "other_needs"=>"",
                                                        "age_min"=>"11", "age_max"=>"99",
                                                        "registration_min"=>"2",
                                                        ...
                                                        "ends_at_time"=>"03:00 PM",
                                                        "datetime_tba"=>"1",
                                                        "location_address"=>"Caroline Wright Art studio",
                                                        "location_address2"=>"1312 E. Cesar Chavez St",
                                                        "location_city"=>"Austin",
                                                        "location_state"=>"TX",
                                                        "location_zipcode"=>"78702",
                                                        "location_private"=>"0",
                                                        ...
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"caroline@carolinewrightart.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
...
first_workshop = maura.workshops.create!(             "host_firstname"=>"Maura",
                                                        ...
                                                        "topic"=>"Dyeing Fabric with Organic & Foraged Dyes",
                                                        "description"=>"Learn traditional fabric dyeing techniques using organically grown, harvested, and foraged natural dyes from around Austin, TX.",
                                                        "skill_list"=>"'dyeing fabric','mixing dyes'",
                                                        "tool_list"=>"'Indigo','Cochineal','Walnut Hulls','Onion Skins','fabric'",
                                                        "requirement_list"=>"",
                                                        "other_needs"=>"",
                                                        "age_min"=>"11", "age_max"=>"99",
                                                        "registration_min"=>"2",
                                                        ...
                                                        "ends_at_time"=>"03:00 PM",
                                                        "datetime_tba"=>"1",
                                                        "location_address"=>"Folk Fibers studio",
                                                        "location_address2"=>"",
                                                        "location_city"=>"Bastrop",
                                                        "location_state"=>"TX",
                                                        "location_zipcode"=>"",
                                                        "location_private"=>"1",
                                                        "location_nbrhood"=>"Bastrop",
                                                        "price"=>"60",
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"maura@folkfibers.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
...
first_workshop = jeannie.workshops.create!(             "host_firstname"=>"Jeannie",
                                                        ...
                                                        "host_business"=>"",
                                                        "topic"=>"Simple Hand-stamped Metal Jewelry",
                                                        "description"=>"Learn to stamp on sterling silver and copper discs and take home your very own creation that day! You'll learn basic stamping techniques, using jewelry hand tools, and the process of oxidation.",
                                                        "skill_list"=>"'metal stamping'",
                                                        "tool_list"=>"'hammers','metal stams','oxidation'",
                                                        "requirement_list"=>"",
                                                        "other_needs"=>"",
                                                        "age_min"=>"11", "age_max"=>"99",
                                                        "registration_min"=>"2",
                                                        ...
                                                        "ends_at_time"=>"03:00 PM",
                                                        "datetime_tba"=>"1",
                                                        "location_address"=>"Jeannie's studio",
                                                        "location_address2"=>"",
                                                        "location_city"=>"Austin",
                                                        "location_state"=>"TX",
                                                        "location_zipcode"=>"78701",
                                                        "location_private"=>"1",
                                                        "location_nbrhood"=>"Austin",
                                                        "price"=>"72",
                                                        "ends_at"=>"09/31/2014",
                                                        "payment_options"=>"Paypal",
                                                        "paypal_email"=>"jeannie@byjeannie.com",
                                                        "sendcheck_address"=>"",
                                                        "sendcheck_address2"=>"",
                                                        "sendcheck_city"=>"",
                                                        "sendcheck_state"=>"",
